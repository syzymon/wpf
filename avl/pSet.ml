...
type 'k t = (*typ calego zbioru z komparatorem*)
  {
    cmp : 'k -> 'k -> int;
    set : 'k set;
  }
...
let make l k r = Node (l, k, r, max (height l) (height r) + 1) (*zalozenia: l, r to poprawne drzewa o roznicy <= 2,
...
(*argument x oznacza caly set z cmp oraz drzewem*)
let is_empty x = 
  x.set = Empty
